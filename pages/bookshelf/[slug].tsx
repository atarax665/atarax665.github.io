...
export const getStaticPaths: GetStaticPaths = async () => {
  // For now, we only have the main bookshelf page
  // In the future, you could add pages like "currently-reading", "favorites", etc.
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  const pageSlug = slug === "index" ? "bookshelf" : slug;
