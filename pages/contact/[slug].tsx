...
export const getStaticPaths: GetStaticPaths = async () => {
  // For now, we only have the main contact page
  // In the future, you could add more contact-related pages like "form", "info", etc.
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  const pageSlug = slug === "index" ? "contact" : slug;
